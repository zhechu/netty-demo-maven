package com.wise.netty.udp.unicast.answer;

import com.wise.netty.udp.unicast.question.UdpQuestionSide;
    ...
    protected void channelRead0(
        ...
        if (UdpQuestionSide.QUESTION.equals(req)) {
            ...
            ctx.writeAndFlush(new DatagramPacket(
                            Unpooled.copiedBuffer(UdpAnswerSide.ANSWER + nextQuote(), CharsetUtil.UTF_8),
                            packet.sender()));
        }
    }
